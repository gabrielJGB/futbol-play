...
const VideoCard = ({ article }) => {
    ...
    return (
        <Link
            ...
            class={"flex flex-col gap-1  relative border border-transparent hover:border-primary  active:border-primary  rounded-lg hover:scale-98 transition-all p-1 hover:bg-background-3 cursor-pointer  "}
            title={article.description}
            >
            {
                "images" in article &&
                <img src={article.images[0].url} class={" mx-auto rounded-lg aspect-video "} alt={"Imagen"} />
            }
